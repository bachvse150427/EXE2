...
class _PerInfoScreenState extends State<PerInfoScreen> {
  ...
  savePerInfo() {
    ...
    DatabaseReference housekeeperRef = FirebaseDatabase.instance.ref().child("users");
    housekeeperRef.child(currentFirebaseUser!.uid).child("users_details").set(housekeeperInfoMap);
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: 'Giới thiệu về bản thân của bạn...',
            ...
            _image == null
              ...
              child: const Center(
                child: Text(
                  'Chụp Một Ảnh Hoặc Một Ảnh Bất Lỳ',
